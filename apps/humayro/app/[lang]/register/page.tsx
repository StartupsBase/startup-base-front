...
export default async function RegisterPage({
  ...
  return (
    <main className="relative isolate flex min-h-[calc(100svh-4rem)] items-center justify-center overflow-hidden bg-background px-4 py-10 sm:px-6 sm:py-14 ">
      <section className="relative w-full max-w-160 overflow-hidden rounded-[2rem] border border-border/70 bg-card/92 p-5 shadow-[0_28px_90px_rgba(0,38,32,.12)] backdrop-blur-xl sm:p-8 dark:border-white/10 dark:bg-[#17251c]/95 dark:shadow-[0_32px_100px_rgba(0,0,0,.32)]">
        <div
          aria-hidden="true"
