...
export function DashboardShell({ children, language }: { children: React.ReactNode; language: string }) {
        ...
        <Sidebar collapsible="icon" variant="inset">
          ...
          <SidebarContent>
            <SidebarGroup>
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={!isOrganizationsPage} tooltip={t("dashboard.title")}>
